...
Public Class Form4
    ...
    Public Sub ChangeWallPaper()
        ...
        Else
            'Throw New FileNotFoundException("My.Resources.ord.jpg")
        End If
    End Sub
    ...
    Private userDir As String = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)
    ...
    Private Sub Form4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        _WallPaperPath = "C:\Users\rytho\source\repos\ByteLok\ByteLok\Opera Snapshot_2024-11-18_172423_www.google.com.bmp"
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        Application.Exit()
        Process.Start("C:\Users\rytho\source\repos\ByteLok\Wall\bin\Debug\Wall.exe")
    End Sub
End Class